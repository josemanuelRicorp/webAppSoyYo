...
import { Accordion, Alert, Col, Fade, Form, Row } from "react-bootstrap";
import {
  link2FieldsEmail,
  link2FieldsPhone,
  link2FieldsWhatsapp,
...
export default function DashboardPrimaryViewNewLogic() {
  ...
  return (
    <DashboardWrapper>
      ...
      <p>
        En este apartado tienes que personalizar la información de los enlaces que
      ...
      <Accordion onSelect={handleSelection}  activeKey={stateAccordion} className={style.accordionCustom}>
        <Accordion.Item eventKey="1" className={style.accordionItemCustom}>
          ...
          <Accordion.Body>
            ...
            <h2>WhatsApp</h2>
              ...
              <Row>
                <Col>
                  <input className="btn-custom" type="submit" value="Save" />
                </Col>
              </Row>
            </Form>
          </Accordion.Body>
        ...
        <Accordion.Item eventKey="3" className={style.accordionItemCustom}>
          <Accordion.Header>Cellphone</Accordion.Header>
          <Accordion.Body>
            <form
              className={style.entryContainer}
            ...
            >
              ...
              <h2>Cellphone</h2>
              <label htmlFor="number">Cellphone:</label>
              <input
                className="input"
                type="text"
                name="number"
